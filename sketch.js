 ...
 if (gameState === START){
  ...
  if (keyDown("space")){
   ...
   bgSound.play();
    ...
    text("1) A poor Girl has lost her way to HOME, help her to  ",10,100);
    text("get back home safely.",150,125)
    text("2) She has lost her way in an UNDEAD forest in ",10,180);
    text(" which a ZOMBIE is trying to EAT her.😱😱😱😨😨😨",10,205);
    text("3)Don't let her TOUCH ANY CREATURE or else ",10,255);
    text(" THE ZOMBIE will get close and 1 more  ",10,280);
    text("touch and she is gone.",20,300);
    text("4)Please collect the gummy Bears That Retain Her",10,340);
   text("ENERGY. ",200,360);
